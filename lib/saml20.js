...
/**
 * @callback onBeforeSignCallback
 * @param  {xmldom.Node} doc - The assertion document node
 * @param  {object} options - The original options
 * @param  {moment} now - The assertion creation time
 */
 ...
 * @param [options.onBeforeSign] {onBeforeSignCallback}
 *
 * // XML Dsig
...
function createAssertion(options, strategies, callback) {
  ...
  if(typeof options.onBeforeSign === 'function') {
    options.onBeforeSign(doc, options, now);
  }
